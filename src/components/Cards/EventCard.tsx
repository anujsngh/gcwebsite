...
const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
        <motion.div
            ...
            className="card lg:card-side bg-base-100 shadow-lg hover:shadow-xl transition-shadow duration-300 my-8 mx-4 overflow-hidden border border-base-200 grain-surface"
        >
